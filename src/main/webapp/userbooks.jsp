...
<%@page import="Persistence.Client_CRUD"%>
<%@page import="Persistence.trainer_CRUD"%>
<%@page import="Helper.Trainer"%>
<%@page import="java.util.ArrayList"%>
...
%>
<input type="submit" name="trainer<%=trainer.getTrainerId()%>" value="Hire">
<%}
